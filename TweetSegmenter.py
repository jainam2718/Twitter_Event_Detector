...
class JJWikSegmenter:
    def __init__(self, wiki_titles_file, max_segment_length=4, hashtag_wt=3, entities_only=False):
        ...
        """
        print('Initializing JJWik Segmenter')
...
if __name__ == '__main__':
    segmenter = JJWikSegmenter(wiki_titles_file='data/enwiki-titles-unstemmed.txt')
